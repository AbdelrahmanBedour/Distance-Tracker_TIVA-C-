...
#define UART0_CLOCK 1					  // TO ACTIVATE UART0 CLOCK
#define PORTA_CLOCK 1  					  // TO ACTIVATE PORTA CLOCK

#define UART5_CLOCK 0x0020
#define PORTE_CLOCK 0x0010

#define LCRH_ENABLE 0x0070 			// WLEN = 11 (DATA BITS = 8) FEN =1 (ENABLE 16 ELEMENTS IN BUFFER)
