...
{
SYSCTL_RCGCUART_REG |= UART0_CLOCK;                                   // ACTIVATE UART0 CLOCK
SYSCTL_REGCGC2_REG  |= PORTA_CLOCK;                                   // ACTIVATE CLOCK FOR PORT A
...
UART0_LCRH_R = LCRH_ENABLE;                                // WLEN = 11 (DATA BITS = 8) FEN =1 (ENABLE 16 ELEMENTS IN BUFFER)
UART0_CTL_R  = CTL_ENABLE;                                 // ENABLE UART , ENABLE TRANSMITTER ,ENABLE RECEIVER
...
{
SYSCTL_RCGCUART_REG |= UART5_CLOCK;                                               // ACTIVATE UART5 CLOCK        0b0010 0000
SYSCTL_REGCGC2_REG  |= PORTE_CLOCK;                            //0b00000100      // ACTIVATE CLOCK FOR PORT E
...
UART5_LCRH_R = LCRH_ENABLE;                                // WLEN = 11 (DATA BITS = 8) FEN =1 (ENABLE 16 ELEMENTS IN BUFFER)
UART5_CTL_R  = CTL_ENABLE;                                 // ENABLE UART , ENABLE TRANSMITTER ,ENABLE RECEIVER
